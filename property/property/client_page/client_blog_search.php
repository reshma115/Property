			          ...
			          <div class="col-md-3">
			            <div class="property-wrap ftco-animate">
			              <div class="img d-flex align-items-center justify-content-center" style="background-image: url('../images1/<?php echo $row["blog_image"]; ?>');">
			                <a href="client-blog-single-page.php?blog_id=<?php echo "{$row['blog_id']}"?>" class="icon d-flex align-items-center justify-content-center btn-custom">
			              ...
			              <div class="text">
			                ...
			                <h3 class="mb-0"><a href="client-blog-single-page.php?blog_id=<?php echo "{$row['blog_id']}"?>"><?php echo $row['blog_name'] ?> </a></h3>
			                <div style="margin-top: 10px;">
			                  <a href="client-blog-single-page.php?blog_id=<?php echo "{$row['blog_id']}"?>" class="btn btn-primary" style="margin-left: 79%;">
			                    <span >Read</span></a>
			                </div>  
			              </div>
			            </div>
