    	...
    	<div class="container">
	    	<div class="row" style="margin-left:300px">
				<div class="col-md-12">
			        ...
			        <form action="client-auto-search-property.php" method="POST" class="search-property-1">
			        	<div class="row">
        	...
        	<div class="col-md-3">        		
        		<div class="property-wrap ftco-animate">
        			<div class="img d-flex align-items-center justify-content-center">
        				...
        				<div class="list-agent d-flex align-items-center">
        					...
        					<div class="tooltip-wrap d-flex">
        						<!-- <a href="#" class="icon-2 d-flex align-items-center justify-content-center" data-toggle="tooltip" data-placement="top" title="Add To Favourite">
        							<span class="ion-ios-heart" onclick="location.href='client-favorite.php';"><i class="sr-only">Add To Favourite</i></span>
        						</a> -->
        			...
        			<div class="text">
        				...
        				<h3 class="mb-0"><a href="client-single-page.php?pcode=<?php echo $pcode;?>">
