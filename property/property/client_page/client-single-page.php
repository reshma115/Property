<?php
	...
	session_start();
		...
		{
		   header("location:client-single-page.php");
		}
		// $q="select * from property_details";
...
<html lang="en">
	<head>
		<title>client-single-page data</title>
		<link rel="shortcut icon" type="image/png" href="../images1/client-icon.png" >
		<meta charset="utf-8">
	    ...
	    <link rel="stylesheet" type="text/css" href="client-single-page.css">
	</head>
	<body>
		...
		<div class="first-container" style="background-color: #ededed; margin-top: -30px">
				...
				<div class="container" style="margin-top:-15px;">
				    ...
				    <div class="collapse navbar-collapse" id="ftco-nav">
					    <ul class="navbar-nav ml-auto">
					        <li class="nav-item"><a href="client-index.php" class="nav-link">Home</a></li>
					        <li class="nav-item"><a href="client-about-us.php" class="nav-link">About Us</a></li>
					       <!--  <li class="nav-item"><a href="#" class="nav-link">Services</a></li> -->
					        ...
					        <li class="nav-item"><a href="client-contact.php" class="nav-link">Contact</a></li>
					    </ul>
				    </div>
				    <div class="dropdown">
			...
			<section class="ftco-section ftco-property-details" style="margin-top:-15%">
			    <div class="container">
			    	...
			    	<form name="add_to_favorite_form" action="#" method="POST" enctype="multipart/form-data" class="fav-form-submit">
			      		<div class="row justify-content-center position-relative">
				      		<div class="col-md-11">
				      			<div class="property-details">	      					      				
			      					<div class="property-details">
			      						<div class="col-md-12  table-responsive-sm card shadow-sm p-3 mb-5 
			      							bg-white rounded">

			      							<div id="fav-message"></div> <!-- display cart msg -->

			      							<!-- Add to Favourite -->
			      							<h2 name="pname" style="color:black; margin: 3px 0px 0px 10px">
			      								<?php echo $res['pname']; ?>&nbsp
			      								<!-- <input type="submit" class="btn btn-danger"
			      								 style="color: white" name="client-fav" id="client-fav" value="Add to Favorite"> -->

			      								<!--  <button class="btn btn-info favItemBtn" name="client-fav" id="client-fav" style="color: white">
			      								 	Add to Favorite
			      								 </button> -->
			      								 <!-- <?php 
			      								 	//while($res=mysqli_fetch_array($result))
													{
			      								 ?> -->
			      								 <!-- <a href="client-favorite-action.php?add=<?=$res['pcode']?>"
			      								 	class="btn btn-info" name="client-fav" id="client-fav" 
			      								 	style="color: white">Add to Favorite</a> -->
			      								 <!-- <?php
			      								 	}
			      								 ?> -->
			      								 <!-- <a href="cart.php?add='.$fetch['id'].'"> Add to Favorite </a><br/><br/> -->

			      								 <!-- <a href="client-favorite.php?id=<?=$row//['id'] ?>" class="btn btn-info" name="client-fav" id="client-fav" style="color: white">Add to Favorite</a> -->
			      							</h2>

					      					<span name="paddress" class="text" style="color:black; margin: 10px 0px 0px 10px">
		      		...
		      		<script type="text/javascript">
		      			$(document).ready(function(){
		      				$(".favItemBtn").click(function(e){
		      					e.preventDefault();
		      					var $form=$(this).closest(".fav-form-submit");
		      					var pname=$form.find(".pname").val();
		      					var paddress=$form.find(".paddress").val();

		      					$.ajax({
		      						url:'client-favorite-action.php',
		      						method:'POST',
		      						data:{pname:pname,paddress:paddress},
		      						success:function(response)
		      						{
		      							$("fav-message").html(response);
			      		...
			      		<div class="col-md-11">
		      				...
		      				<!-- 	<div class="property-details"> -->
		      						<div class="col-md-12  table-responsive-sm card shadow-sm p-3 mb-5 bg-white rounded">
		      							...
		      							<?php echo '<video width="600" controls autoplay style="margin-left:230px; margin-bottom: 50px">
