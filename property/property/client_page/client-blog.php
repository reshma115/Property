            ...
            <div class="col s12 m7">
              <div class="card" style="width: 250px;">
                <div class="card-image">
                   <a href="client-blog-single-page.php?blog_id=<?php echo "{$res['blog_id']}" ?>"> <?php echo '<img src="../images1/'.$res['blog_image'].'" alt="Blog_image" style="height: 165px">' ?></a>
                ...
                <div class="card-content">
                  <p><h6 style="padding-bottom: 10px"><?php echo $res['blogtype'] ?></h6></p> 
                      <?php echo "<a href='client-blog-single-page.php?blog_id={$res['blog_id']}' style='color: black;'> {$res['blog_name']}</a>"?> <!-- text-decoration: none; -->
          ...
          <div class="col-md-12">
            <div class="property-wrap ftco-animate">
              <div class="img d-flex align-items-center justify-content-center" style="background-image: url('../images1/<?php echo $res["blog_image"]; ?>');">
                <a href="client-blog-single-page.php?blog_id=<?php echo "{$res['blog_id']}"?>" class="icon d-flex align-items-center justify-content-center btn-custom">
              ...
              <div class="text">
                ...
                <h3 class="mb-0"><a href="client-blog-single-page.php?blog_id=<?php echo "{$res['blog_id']}"?>"><?php echo $res['blog_name'] ?></a></h3>
                <div>
                  <a href="client-blog-single-page.php?blog_id=<?php echo "{$res['blog_id']}"?>" class="btn btn-primary" style="margin-left: 84%;">
      ...
      <!-- blog autosearch -->
        ...
        <div class="col-md-12">
            <div class="search-wrap-1 ftco-animate ">
                <form action="client_blog_search.php" method="POST" class="search-property-1">
                  <div class="row">
